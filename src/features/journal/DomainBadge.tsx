...
export function DomainBadge({ domain }: DomainBadgeProps) {
  ...
  return (
    <span
      className="shrink-0 rounded-[var(--radius-xs)] border border-[var(--color-amber-border)] bg-[var(--color-amber-bg)] px-1.5 py-0.5 text-[10px] font-medium uppercase tracking-[.06em]"
